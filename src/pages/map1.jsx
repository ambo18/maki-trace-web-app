...
const Map = () => {
  ...
  // Center of map (General MacArthur, Eastern Samar, Visayas, Philippines)
  ...
  return (
    <div className="bg-bg-color flex flex-col md:flex-row items-start">
      ...
      <div className="h-screen w-full z-0">
        <GoogleMap center={defaultCoordinates} zoom={10} mapContainerStyle={{ width: "100%", height: "100%" }} options={{ zoomControl: false, streetViewControl: false, mapTypeControl: false, fullscreenControl: false }}>
          {/* Markers */}
